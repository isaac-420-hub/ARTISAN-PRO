...
const Section3 = () => {
  ...
  return (
    <section className="w-full bg-[#F8FAFC] dark:bg-slate-900 py-16 md:py-20 lg:py-24">
          ...
          {projects.map((project, index) => (
            ...
            >
              <div className="relative w-full aspect-[4/3]">
                ...
                />
                {/* لایه تاریک روی هاور - Light/Dark variants */}
                <div className="absolute inset-0 bg-[#0B1D3A]/0 group-hover:bg-[#0B1D3A]/20 dark:group-hover:bg-[#0B1D3A]/40 transition-colors duration-500" />
              </div>
            </div>
          ))}
        </div>
