    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-12">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 xl:gap-20 items-center">
        ...
        <div className="order-2 lg:order-1">
          ...
          <p
            className="text-base md:text-lg text-slate-600 leading-relaxed mb-8 max-w-2xl animate-slide-right"
        ...
        >
          <div className="relative w-full aspect-[3/4] md:aspect-[3/3] rounded-3xl overflow-hidden shadow-2xl group">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-[#0B1D3A]/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
          </div>
        </div>
      </div>
    </div>
